...
public:
    ...
    void print_summary()
    {
        ...
        std::cout << "Pass Rate: " << (total > 0 ? (100.0 * passed / total) : 0) << "%"
                  << std::endl;
...
#define ASSERT_EQ(a, b)                                                                            \
    if ((a) != (b))                                                                                \
    {                                                                                              \
        g_test_result.record_fail(#a " == " #b, "values not equal");                               \
        return;                                                                                    \
    }
#define ASSERT_TRUE(cond)                                                                          \
    if (!(cond))                                                                                   \
    {                                                                                              \
        g_test_result.record_fail(#cond, "condition false");                                       \
        return;                                                                                    \
    }
#define ASSERT_FALSE(cond)                                                                         \
    if ((cond))                                                                                    \
    {                                                                                              \
        g_test_result.record_fail(#cond, "condition true");                                        \
        return;                                                                                    \
    }
#define RUN_TEST(name)                                                                             \
    {                                                                                              \
        test_##name();                                                                             \
        g_test_result.record_pass(#name);                                                          \
    }
...
int main()
{
    ...
    {
        g_test_result.record_fail("InitialStateIsPending", "exception");
    }
    ...
    {
        g_test_result.record_fail("PendingToReady", "exception");
    }
    ...
    {
        g_test_result.record_fail("ReadyToRunning", "exception");
    }
    ...
    {
        g_test_result.record_fail("RunningToCompleted", "exception");
    }
    ...
    {
        g_test_result.record_fail("RunningToFailed", "exception");
    }
    ...
    {
        g_test_result.record_fail("RunningToPaused", "exception");
    }
    ...
    {
        g_test_result.record_fail("PausedToRunning", "exception");
    }
    ...
    {
        g_test_result.record_fail("FailedToPending_Retry", "exception");
    }
    ...
    {
        g_test_result.record_fail("FailedToRollingBack", "exception");
    }
    ...
    {
        g_test_result.record_fail("RollingBackToRolledBack", "exception");
    }
    ...
    {
        g_test_result.record_fail("RolledBackToPending", "exception");
    }
    ...
    {
        g_test_result.record_fail("CannotTransitionFromCompletedState", "exception");
    }
    ...
    {
        g_test_result.record_fail("CannotTransitionFromCancelledState", "exception");
    }
    ...
    {
        g_test_result.record_fail("ValidNextStatesFromPending", "exception");
    }
    ...
    {
        g_test_result.record_fail("ValidNextStatesFromRunning", "exception");
    }
    ...
    {
        g_test_result.record_fail("PauseResumeRerunCycle", "exception");
    }
    ...
    {
        g_test_result.record_fail("RollbackCycle", "exception");
    }
    ...
    {
        g_test_result.record_fail("CancelFromPending", "exception");
    }
    ...
    {
        g_test_result.record_fail("CancelFromRunning", "exception");
    }
    ...
    {
        g_test_result.record_fail("TaskIdGenerateCreatesUniqueIds", "exception");
    }
    ...
    {
        g_test_result.record_fail("TimestampNow", "exception");
    }
    ...
    {
        g_test_result.record_fail("PriorityComparisons", "exception");
    }
