...
public:
    ...
    const std::vector<AuditRecord> &audit_records() const
    {
...
private:
    void transition(device_automation::domain::Task &task,
                    device_automation::domain::TaskState next, const std::string &reason);
    void record_audit(const device_automation::domain::Task &task,
                      device_automation::domain::TaskState before,
                      device_automation::domain::TaskState after, const std::string &reason);
